...
<nav class="sk-nav">
  <a class="sk-nav-logo" href="/">
    <img src="/favicon.svg" alt="sorokit" class="sk-nav-favicon" />
    <span>sorokit</span>
  </a>
  <div class="sk-nav-links">
    <a href="/guide/getting-started">guide</a>
    <a href="/reference/core/wallet">reference</a>
    <a href="/contributing">contributing</a>
    <a href="https://github.com/Just-Bamford/sorokit-core" target="_blank">github</a>
  </div>
</nav>
...
<div class="sk-page">
  <section class="sk-hero-section">
    <div class="sk-hero-content">
      <h1 class="sk-hero-title">sorokit</h1>
      <p class="sk-hero-tagline">TypeScript SDK for Stellar and Soroban. Framework-agnostic core. Drop-in React UI kit. Built for contributors.
      </p>
    </div>  
    <div class="sk-hero-actions">
      <a class="sk-btn-brand" href="/guide/getting-started">Get started</a>
      <a class="sk-btn-alt" href="/reference/core/wallet">Core API</a>
      <a class="sk-btn-alt" href="/reference/ui/components">UI kit</a>
    </div>
