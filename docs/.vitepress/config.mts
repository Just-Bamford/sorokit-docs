  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "contributing", link: "/contributing" },
      {
        ...
        items: [
          ...
          {
            text: "sorokit-core",
            link: "https://github.com/Sorokit/sorokit-core",
          },
          { text: "sorokit-ui", link: "https://github.com/Sorokit/sorokit-ui" },
        ],
      },
    ],
    ...
    sidebar: {
      ...
      "/reference/": [
        ...
        {
          text: "@sorokit/ui",
          items: [{ text: "components", link: "/reference/ui/components" }],
        },
      ],
    },

    socialLinks: [{ icon: "github", link: "https://github.com/Sorokit" }],
